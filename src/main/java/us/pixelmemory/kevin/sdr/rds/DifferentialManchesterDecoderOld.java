 ...
 * @param <T>
 */
public class DifferentialManchesterDecoderOld<T extends Exception> implements BooleanConsumer<T> {
	...
	public DifferentialManchesterDecoderOld(final int samplesPerSymbol, final boolean transitionSymbol, final BooleanConsumer<T> out) {
